    ...
    <form @submit.prevent="handleSubmit" class="simulation-form">
      ...
      <fieldset class="form-group-fieldset">
        ...
        <div class="form-group">
          ...
          <input id="unityProjectId" v-model="simulation.unityProjectId" type="text" placeholder="***REMOVED***" required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input id="unityConfigId" v-model="simulation.unityConfigId" type="text" placeholder="***REMOVED***" required />
        </div>
      </fieldset>
